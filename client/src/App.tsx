...
function App() {
  ...
  return <ErrorBoundary><ThemeProvider defaultTheme="light"><TooltipProvider><Toaster richColors position="bottom-right" duration={toastDuration} /><Home /></TooltipProvider></ThemeProvider></ErrorBoundary>;
}
